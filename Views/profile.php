...
<head>
    ...
    <title>Profile - Medi Express</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow">
                                    ...
                                    <div class="mb-3"><button class="btn btn-success text-white btn-sm" type="button">Change Photo</button></div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-success m-0 fw-bold">User Settings</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                ...
                                                <div class="mb-3"><button class="btn btn-success text-white btn-sm" type="submit">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="card shadow">
                                        <div class="card-header py-3">
                                            <p class="text-success m-0 fw-bold">Contact Settings</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-header py-3">
                            <p class="text-success m-0 fw-bold">Forum Settings</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
